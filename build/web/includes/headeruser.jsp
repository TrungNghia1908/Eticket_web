        ...
        <nav class="navbar navbar-custom">
            <div class="container">
                <ul class="nav navbar-nav">
                    <li><form action="<c:url value='/user/showSchedule'/>" method="POST">
                                        <input type="submit" value="List of trip" class="link">
                                    </form></li>
                    <li><form action="<c:url value='/user/ViewBooking'/>" method="POST">
                                        <input type="submit" value="View Booking" class="link">
                                    </form></li>
                    <li><form action="<c:url value='/user/Feedback'/>" method="POST">
                                        <input type="submit" value="Send Feedback" class="link">
                                    </form></li>
                </ul>
            </div>
        </nav>
