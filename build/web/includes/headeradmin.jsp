                            ...
                            <ul class="list-inline">
                                <li>
                                    <form action="<c:url value='/user/logout'/>" method="POST">
                                        <input type="submit" value="Logout" class="button scpecial">
                                    </form>
                                </li>
                            </ul>
                        </div>
        ...
        <nav class="navbar navbar-custom">
            <div class="container">
                <ul class="nav navbar-nav">
                    ...
                    <li><form action="<c:url value='/admin/showCustomer'/>" method="POST">
                    ...
                    <li><form action="<c:url value='/admin/ViewBooking'/>" method="POST">
